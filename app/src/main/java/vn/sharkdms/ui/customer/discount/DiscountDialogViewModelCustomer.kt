...
@HiltViewModel
class DiscountDialogViewModelCustomer @Inject constructor(private val baseApi: BaseApi) : ViewModel() {
    ...
    fun sendGetCompanyDiscountInfo(token: String) {
        viewModelScope.launch {
            ...
            try {
                val response = baseApi.getCompanyDiscountCustomer(authorization)
